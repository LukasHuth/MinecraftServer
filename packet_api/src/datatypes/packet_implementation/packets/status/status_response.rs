...
impl Packet for StatusResponse {
    fn read(_stream: &mut std::io::BufReader<&mut std::net::TcpStream>) -> Result<StatusResponse, DatastructError> where Self: Sized {
        unreachable!()
    }
    ...
    fn read_length(_stream: &mut std::io::BufReader<&mut std::net::TcpStream>, _length: VarInt) -> Result<StatusResponse, DatastructError> where Self: Sized {
        unreachable!()
    }
}
impl StatusResponse {
